...
class GmailThread:
    ...
    def trash(self):
        """Put entire thread into the Trash folder where it will be automatically removed in 30 days.
...
class GmailMessage:
    ...
    def trash(self):
        """Put message into the Trash folder where it will be automatically removed in 30 days.
        This is the preferred method to deleting a thread according to the documentation."""
        trash(self)
